...
class ModelManager {
  ...
  def findSheet(id: Long)(implicit userId: Long):Option[Sheet]
    = sheetManager.find(id)(userId)

  def deleteSheet(id: Long)(implicit userId: Long):Unit
    = sheetManager.delete(id)(userId)
  ...
  def findAllWalls()(implicit userId: Long):List[Wall]
    = wallManager.findAll()(userId)

  def findWall(id: Long)(implicit userId: Long):Option[Wall]
    = wallManager.find(id)(userId)
  ...
  def setWallTitle(baseLogId:Long, action:ChangeTitleAction)(implicit userId: Long):LogCreationResult
    = withTransaction {
  ...
  def getSheetsInWall(id: Long)(implicit userId: Long):List[Sheet]
    = wallManager.getSheets(id)(userId)

  def getSheetIdsInWall(id: Long)(implicit userId: Long):Set[Long]
    = wallManager.getSheetIds(id)(userId)

  def createSheetInWall(baseLogId:Long, action:CreateSheetAction)(implicit userId: Long):LogCreationResultWithId
    = withTransaction {
  ...
  def deleteSheetInWall(baseLogId:Long, action:DeleteSheetAction)(implicit userId: Long):LogCreationResult
    = withTransaction {
